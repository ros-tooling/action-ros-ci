...
EOF`], options);
            ...
            yield exec.exec("bash", ["-c", `source install/local_setup.bash && colcon build --event-handlers console_cohesion+ --packages-up-to ${packageName} --symlink-install ${extra_options.join(" ")}`], options);
