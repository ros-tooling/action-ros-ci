...
function watch(path, options, extra) {
    ...
    return chokidar_1.default.watch(path, Object.assign({ ignoreInitial: true, persistent: false, useFsEvents: false }, options));
}
/**
...
function calculateProjectParserOptions(code, filePath, extra) {
    ...
    for (const rawTsconfigPath of extra.projects) {
        ...
        watchCompilerHost.watchFile = (fileName, callback, interval) => {
        ...
        watchCompilerHost.watchDirectory = (dirPath, callback, recursive) => {
...
function createProgram(code, filePath, extra) {
    ...
    const commandLine = ts.getParsedCommandLineOfConfigFile(tsconfigPath, exports.defaultCompilerOptions, Object.assign(Object.assign({}, ts.sys), { onUnRecoverableConfigFileDiagnostic: () => { } }));
    if (!commandLine) {
        return undefined;
    }
